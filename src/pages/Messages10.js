...
import styles from "./Messages10.module.css";
    ...
    <>
      <div className={styles.messages}>
        <BookingContainer
          ...
          containerDisplay1="none"
          containerDisplay2="flex"
        />
          ...
          <div className={styles.subTabActivities}>
            <div className={styles.tabsSubSwitch}>
              <div className={styles.allParent}>
                ...
                >
                  <div className={styles.booking4}>Promotion</div>
                </div>
