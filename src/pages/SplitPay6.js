...
import styles from "./SplitPay6.module.css";
...
const SplitPay6 = () => {
  return (
    <div className={styles.splitPay}>
      ...
      />
      <SplitPayContainer
        avatarImageUrl="../avatar130.svg"
        avatarImageUrls="../avatar131.svg"
        avatarImageUrls2="../avatar132.svg"
        avatarImageUrls3="../avatar133.svg"
        paymentImageUrl="../mastercard-14.svg"
        paymentLogoUrl="../paypal-28.svg"
      />
      <div className={styles.overlay} />
      <div className={styles.loader}>
        <img
          className={styles.animation500Ksqlgxr31Icon}
          alt=""
          src="../animation-500-ksqlgxr3-1@2x.png"
        />
      </div>
    </div>
  );
