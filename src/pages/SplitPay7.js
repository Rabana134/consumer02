...
import styles from "./SplitPay7.module.css";
  ...
  return (
    <>
      <div className={styles.splitPay}>
        ...
        <SectionForm />
        <div className={styles.splitPayInner}>
          <div className={styles.walletLineParent}>
            <img
              className={styles.walletLineIcon}
              alt=""
              src="../wallet-line.svg"
            />
            <div className={styles.youHaveNo}>
              You have no split pay request
            </div>
          </div>
        </div>
