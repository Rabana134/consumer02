...
import styles from "./Messages14.module.css";
    ...
    <>
      <div className={styles.messages}>
        ...
        <div className={styles.overlay}>
          <JobStatusContainer
            starIconUrls="iconsstar285.svg"
            starRatingIconUrls="iconsstar285.svg"
            placeholderIconUrls="iconsstar285.svg"
            addCancelIconUrl="iconsstar285.svg"
            ratingValues="4.0"
            placeholderIconUrls20px="icons20pxplaceholder82.svg"
            addCancelIconUrls="../addcancel-circle14.svg"
            addIconUrls="iconsadd31.svg"
            addCancelIconUrls14px="../addcancel-circle14.svg"
            addIconUrls31and41="iconsadd31.svg"
            addCancelIconUrls14px2="../addcancel-circle14.svg"
            propCursor="pointer"
            onFrameContainer22Click={onFrameContainer22Click}
            onUploadImageContainerClick={onUploadImageContainerClick}
          />
        </div>
      </div>
      {isAccountOpen && (
