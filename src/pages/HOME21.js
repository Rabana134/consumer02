...
import SplitPayRequestContainer from "../components/SplitPayRequestContainer";
import styles from "./HOME21.module.css";
  ...
  return (
    <>
      <div className={styles.home}>
        <MessageContainer
          avatarImageUrl="../avatar42.svg"
          avatarImageUrls="../avatar43.svg"
          avatarImageUrls2="../avatar44.svg"
          avatarImageUrls3="../avatar45.svg"
          avatarPrice="£630"
        />
        <PrototypeContainer
