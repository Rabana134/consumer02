...
import styles from "./LogCashTransactions1.module.css";

const LogCashTransactions1 = () => {
  ...
  return (
    <>
      <div className={styles.logCashTransactions}>
        ...
        <SectionForm />
        <img className={styles.withdrawalIcon} alt="" src="../withdrawal.svg" />
        <img className={styles.depositIcon} alt="" src="../deposit.svg" />
        ...
        <div className={styles.failed}>
          ...
          <div className={styles.pending1}>failed</div>
        </div>
        <img className={styles.depositIcon1} alt="" src="../deposit1.svg" />
        <img
          className={styles.withdrawalIcon1}
          alt=""
          src="../withdrawal1.svg"
        />
        <img
          className={styles.withdrawalIcon2}
          alt=""
          src="../withdrawal2.svg"
        />
        <div className={styles.logCashTransactionsChild} />
          ...
          <div className={styles.frameParent4}>
            ...
            <div className={styles.largeButtons2}>
              <img
                ...
                alt=""
                src="../icons20pxplaceholder436.svg"
              />
              <b className={styles.label}>Deposit</b>
              <img
                className={styles.icons20pxplaceholder}
                alt=""
                src="../icons20pxplaceholder436.svg"
          ...
          <div className={styles.recentTransactionsParent}>
            ...
            <div className={styles.transactionHistoryParent}>
              <TransactionHistoryContainer
                transactionStatus="../transaction-icons.svg"
                transactionType="Deposit"
                transactionAmount="£1500"
                transactionStatusText="PENDING"
                propBackgroundColor="#fffbf5"
                propColor="#ed721c"
              />
              <TransactionHistoryContainer
                transactionStatus="../transaction-icons1.svg"
                transactionType="Job payment"
                transactionAmount="£150"
                transactionStatusText="SUCCESS"
                propBackgroundColor="#edf9e6"
                propColor="1.5px solid #2fa500"
              />
              <TransactionHistoryContainer
                transactionStatus="../transaction-icons.svg"
                transactionType="Referral earning"
        ...
        <CarpenterNavContainer
          addIconUrl="icons16pxadd154.svg"
          searchIconUrl="icons20pxsearch85.svg"
          paymentType="Log Cash"
...
export default LogCashTransactions1;
