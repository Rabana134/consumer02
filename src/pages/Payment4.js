...
import styles from "./Payment4.module.css";
...
const Payment4 = () => {
  return (
    <div className={styles.payment}>
      ...
      />
      <PaymentCard mastercardLogoUrl="../mastercard-110.svg" propGap="16px" />
      ...
      <div className={styles.overlay}>
        <div className={styles.frameParent3}>
          ...
          <div className={styles.frameParent4}>
            <div className={styles.inputactivedefaultParent}>
              <div className={styles.inputactivedefault}>
                <div className={styles.label2}>Name on Card</div>
                <div className={styles.baseField}>
                  ...
                  />
                  <div className={styles.userInput}>Devon Lane</div>
                  <div className={styles.dot}>
                    <img
                      className={styles.dotChild}
                      alt=""
                      src="../ellipse-2514.svg"
                    />
                    <img
                      className={styles.dotChild}
                      alt=""
              ...
              <CardInput
                ...
                cardName="iconsplaceholder44.svg"
                cardNumberText="8452 3200 5490 0002"
                cardIconUrl="ellipse-2513.svg"
                cardSecurityCode="ellipse-2513.svg"
                cardExpiryDate="ellipse-2513.svg"
                cardSecurityIconUrl="ellipse-2513.svg"
                cardSecurityText="ellipse-2513.svg"
                cardSecurityIconUrl2="ellipse-2513.svg"
                cardSecurityIconUrl3="ellipse-2513.svg"
                cardSecurityIconUrl4="ellipse-2513.svg"
                cardSecurityIconUrl5="ellipse-2513.svg"
                propWidth="397px"
                propHeight="48px"
                propColor="#2e2e2e"
              />
            ...
            <div className={styles.largeButtons2}>
              ...
              <b className={styles.label}>Save Card</b>
