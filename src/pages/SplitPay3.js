...
import SplitPayForm from "../components/SplitPayForm";
import styles from "./SplitPay3.module.css";
...
const SplitPay3 = () => {
  return (
    <div className={styles.splitPay}>
      ...
      />
      <SplitPayForm
        avatarImageUrl="avatar142.svg"
        avatarImageUrls="avatar143.svg"
        avatarImageUrlsBySize="avatar144.svg"
        avatarImageUrlsByNumber="avatar145.svg"
        iconImageUrls="icons20pxplaceholder256.svg"
        iconImageUrlsBySize="icons20pxplaceholder256.svg"
        iconImageUrlsByNumber="icons20pxplaceholder258.svg"
        iconImageUrls20px="icons20pxplaceholder258.svg"
        iconImageUrls20pxPlacehol="icons20pxplaceholder260.svg"
        iconImageUrls20pxPlacehol2="icons20pxplaceholder260.svg"
        paypalImageUrls="../paypal-211.svg"
      />
        ...
        <div className={styles.popupModal}>
          ...
          <div className={styles.bookingsCardParent}>
              ...
              <div className={styles.avatarParent}>
                ...
                <div className={styles.peoplenameParent}>
                  ...
                  <div className={styles.dateParent}>
                    <div className={styles.label}>26/06/2021</div>
                    <div className={styles.rectangleDiv} />
                    <div className={styles.label}>{`6:32AM `}</div>
                  </div>
                </div>
              </div>
                ...
                <div className={styles.frameParent4}>
                  <div className={styles.mdilinkedinParent}>
                    <img
                      ...
                      alt=""
                      src="../iconscalendar66.svg"
                    />
                    <div className={styles.label}>{`09/06/2021 `}</div>
                  </div>
                  <div className={styles.mdilinkedinParent}>
                    <img
                      className={styles.iconscalendar}
                      ...
                      src="../iconsclock7.svg"
                    />
                    <div className={styles.label}>9:00AM</div>
                  </div>
                  <div className={styles.mdilinkedinParent}>
                    <img
                      className={styles.iconscalendar}
                      alt=""
                      src="../iconsduration7.svg"
                    />
                    <div className={styles.label}>5 days</div>
                  </div>
                </div>
                <div className={styles.mdilinkedinParent}>
                  <img
            ...
            <div className={styles.largeButtons2}>
              <img className={styles.iconsadd} alt="" src="../iconsadd25.svg" />
