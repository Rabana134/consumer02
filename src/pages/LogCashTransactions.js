...
import styles from "./LogCashTransactions.module.css";

const LogCashTransactions = () => {
    ...
    <>
      <div className={styles.logCashTransactions}>
        ...
        <div className={styles.listParent}>
          <ContainerList
            notificationIconUrl="../icon-with-bg.svg"
            notificationType="Push Notifications"
            notificationIconBackgroun="../ellipse-9.svg"
            propBorderBottom="1px solid var(--grey-801)"
          />
          <ContainerList
            notificationIconUrl="../icon-with-bg.svg"
            notificationType="Email Notifications"
            notificationIconBackgroun="../ellipse-91.svg"
          />
          <ContainerList
            notificationIconUrl="../icon-with-bg2.svg"
            notificationType="Promotion Management"
            notificationIconBackgroun="../ellipse-92.svg"
...
export default LogCashTransactions;
